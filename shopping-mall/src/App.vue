        ...
        <div class="app-head">
          <div class="app-head-inner">
            ...
            <div class="head-nav">
              <ul class="nav-list">
                <li>{{username}}</li>
                <li v-if='username==""' @click='openDialog("isShowLogDialog")'>登录</li>
                <li class='nav-pile'>|</li>
                <li v-if='username !==""' @click='quit'>退出</li>
                <li v-if='username==""' @click='openDialog("isShowRegDialog")'>注册</li>
                <li class='nav-pile'>|</li>
